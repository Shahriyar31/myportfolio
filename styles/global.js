...
(() => {
    ...
    l.href = "https://fonts.googleapis.com/css2?family=Clash+Display:wght@400;500;600;700&family=Satoshi:wght@400;500;700&family=JetBrains+Mono:wght@400;500;600&display=swap";
    l.rel = "stylesheet";
...
GS.textContent = `
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700;800&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500;600&display=swap');
...
#cd{position:fixed;width:10px;height:10px;border-radius:50%;background:var(--ca);pointer-events:none;z-index:9999;transform:translate(-50%,-50%);mix-blend-mode:difference}
#cr{position:fixed;width:40px;height:40px;border-radius:50%;border:1.5px solid var(--ca);pointer-events:none;z-index:9998;transform:translate(-50%,-50%);opacity:.35;transition:width .25s,height .25s,opacity .2s}
body.ch #cd{width:20px;height:20px}
body.ch #cr{width:70px;height:70px;opacity:.12}
...
.rv2{opacity:0;transform:translateY(24px);transition:opacity .8s .18s ease,transform .8s .18s ease}
.rv2.vi{opacity:1;transform:translateY(0)}
.rv3{opacity:0;transform:translateY(24px);transition:opacity .8s .34s ease,transform .8s .34s ease}
...
.edu-timeline{max-width:800px;margin:0 auto;position:relative}
